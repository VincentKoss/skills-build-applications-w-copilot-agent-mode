...
test_data = {
    "users": [
        {"_id": ObjectId(), "username": "thundergod", "email": "thundergod@octofit.edu", "password": "password123"},
        {"_id": ObjectId(), "username": "metalgeek", "email": "metalgeek@octofit.edu", "password": "password123"},
        {"_id": ObjectId(), "username": "zerocool", "email": "zerocool@octofit.edu", "password": "password123"},
        {"_id": ObjectId(), "username": "crashoverride", "email": "crashoverride@octofit.edu", "password": "password123"},
        {"_id": ObjectId(), "username": "sleeptoken", "email": "sleeptoken@octofit.edu", "password": "password123"},
    ],
    "teams": [
